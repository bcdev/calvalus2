 ...
 * @author thomas
 */
public class ObsoleteFireFormattingProductionType extends HadoopProductionType {

    public static class Spi extends HadoopProductionType.Spi {

        @Override
        public ProductionType create(InventoryService inventory, HadoopProcessingService processing, StagingService staging) {
            return new ObsoleteFireFormattingProductionType(inventory, processing, staging);
        }
    }

    ObsoleteFireFormattingProductionType(InventoryService inventoryService, HadoopProcessingService processingService,
                                         StagingService stagingService) {
        super("Obsolete-Fire-Formatting", inventoryService, processingService, stagingService);
    }
    ...
    public Production createProduction(ProductionRequest productionRequest) throws ProductionException {
        ...
        String outputPath = getOutputPath(productionRequest, productionId, "Obsolete-Fire-Formatting");
