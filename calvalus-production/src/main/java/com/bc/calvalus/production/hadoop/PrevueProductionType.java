...
public class PrevueProductionType extends HadoopProductionType {
    ...
    public static class Spi extends HadoopProductionType.Spi {
        ...
        public ProductionType create(FileSystemService fileSystemService, HadoopProcessingService processing, StagingService staging) {
            return new PrevueProductionType(fileSystemService, processing, staging);
        }
    }

    PrevueProductionType(FileSystemService fileSystemService, HadoopProcessingService processingService,
                                StagingService stagingService) {
        super("Prevue", fileSystemService, processingService, stagingService);
    }
    ...
    protected Staging createUnsubmittedStaging(Production production) {
        throw new UnsupportedOperationException("Staging currently not implemented for prevue.");
    }
