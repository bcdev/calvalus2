...
public class ProductionServiceImplTest {
    ...
    public void testGetProductSets() throws ProductionException {
        ...
        assertEquals("entry1", productSets[0].getPath());
        assertEquals("entry1/entry1", productSets[1].getPath());
        assertEquals("entry1/entry2", productSets[2].getPath());
        assertEquals("entry1/entry3", productSets[3].getPath());
        ...
        assertEquals("entry3", productSets[8].getPath());
        assertEquals("entry3/entry1", productSets[9].getPath());
        assertEquals("entry3/entry2", productSets[10].getPath());
        assertEquals("entry3/entry3", productSets[11].getPath());
    }
