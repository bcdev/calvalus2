...
public class CalvalusConfig {
    ...
    public Map<String, String> getDefaultConfig(CalvalusDataInputs calvalusDataInputs) {
        ...
        defaultConfig.put("calvalus.calvalus.bundle", getConfig(calvalusDataInputs.getValue("calvalus.calvalus.bundle"), DEFAULT_CALVALUS_BUNDLE));
        defaultConfig.put("calvalus.beam.bundle", getConfig(calvalusDataInputs.getValue("calvalus.beam.bundle"), DEFAULT_BEAM_BUNDLE));
        defaultConfig.put("calvalus.wps.staging.path", getConfig(calvalusDataInputs.getValue("calvalus.wps.staging.path"), STAGING_DIRECTORY));
