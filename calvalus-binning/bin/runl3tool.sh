...
echo hadoop --config ${configDir} jar ${jobJar} com.bc.calvalus.binning.job.L3Tool $@
time hadoop --config ${configDir} jar ${jobJar} com.bc.calvalus.binning.job.L3Tool $@ 2>&1 |tee ${logfile}.tmp
