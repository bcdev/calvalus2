...
public class Example_BoxAndWhisker_TimeY {
    private static Font font = new Font(Font.SANS_SERIF, Font.PLAIN, 17);

    public static void main(String[] args) {
        JFreeChart chart = createCustomisedChart(createTimeSeriesDataset());
...
//                       ((Example_BoxAndWhiskerXYDataset) dataset).getRangeUpperBound(true));
    ...
    private static AbstractXYDataset createTimeSeriesDataset() {
        final int VALUE_COUNT = 20;
        //is a XYDataset where x is time
