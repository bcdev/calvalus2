...
class JobDetailType implements Comparable<String> {
    ...
    void setJobInfo(com.bc.calvalus.extractor.jobs.JobType jobType) {
    ...
    void setCounterInfo(CountersType countersType) {
        List<com.bc.calvalus.extractor.counter.CounterType> counter = countersType.getCounterGroup().getCounter();
        for (com.bc.calvalus.extractor.counter.CounterType counterType : counter) {
            addCounterInfo(counterType);
        }
    }

    private void addCounterInfo(com.bc.calvalus.extractor.counter.CounterType counterType) {
