package com.bc.calvalus.reporting.extractor.counter;
...
public class CounterExtractor extends Extractor {
    ...
    @Override
    public <T> HashMap<String, T> extractInfo(int from, int to, List<com.bc.calvalus.reporting.extractor.jobs.JobType> jobTypes) throws ExtractCalvalusReportException {
        ...
        try {
            for (int i = from; i < to; i++) {
                com.bc.calvalus.reporting.extractor.jobs.JobType jobType = jobTypes.get(i);
