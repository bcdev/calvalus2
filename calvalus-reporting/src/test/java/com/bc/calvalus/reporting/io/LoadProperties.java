...
public class LoadProperties extends BlockJUnit4ClassRunner {
    private static final String CALVALUS_LOG_EXECUTE_TEST = "com.bc.calvalus.reporting.io";
    private Class<?> klass;
    ...
    public LoadProperties(Class<?> klass) throws InitializationError, IOException {
        ...
        if (!exists) {
            System.out.println("Set the absolute file path to resource/log-file, In the conf/calvalus-reporting.properties");
