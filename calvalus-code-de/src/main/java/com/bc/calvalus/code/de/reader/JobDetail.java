...
public class JobDetail {
    ...
    public JobDetail(String user, String queue, String state, String jobId, String jobName, String startTime, String inputPath, String finishTime, String mapsCompleted, String reducesCompleted, String fileBytesRead, String fileBytesWritten, String hdfsBytesRead, String hdfsBytesWritten, String vCoresMillisTotal, String mbMillisMapTotal, String mbMillisReduceTotal, String cpuMilliseconds, String totalMaps, String remoteUser, String remoteRef, String processType, String wpsJobId, String workflowType, String inProductType, String dataProcessorUsed) {
        this.user = user;
        this.queue = queue;
        this.state = state;
        this.jobId = jobId;
