...
public class CalvalusProductionService {
    ...
    public synchronized static ProductionService getInstance(CalvalusConfig calvalusConfig) throws IOException, ProductionException {
        if (productionService == null) {
            productionService = createProductionService(calvalusConfig);
        }
        return productionService;
    }

    private static ProductionService createProductionService(CalvalusConfig calvalusConfig) throws ProductionException, IOException {
