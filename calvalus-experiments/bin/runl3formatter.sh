...
echo hadoop --config ${configDir} jar ${jobJar} com.bc.calvalus.b3.job.L3Formatter $@
time hadoop --config ${configDir} jar ${jobJar} com.bc.calvalus.b3.job.L3Formatter $@ 2>&1 |tee ${logfile}.tmp 
