...
public class CalvalusProcessorTest {
    ...
    public void canGetParameterDescriptors() throws Exception {
        ProcessorDescriptor.ParameterDescriptor[] mockParameterDescriptors = getParameterDescriptors();
        ...
        ProcessorDescriptor.ParameterDescriptor parameter1 = parameterDescriptors[0];
        ProcessorDescriptor.ParameterDescriptor parameter2 = parameterDescriptors[1];
    ...
    private Map<String, String> getJobConfiguration() {
        ...
        jobConfiguration.put("calvalus.snap.bundle", "snap-3.0.0");
        return jobConfiguration;
    }

    private ProcessorDescriptor.ParameterDescriptor[] getParameterDescriptors() {
        List<ProcessorDescriptor.ParameterDescriptor> parameterDescriptorList = new ArrayList<>();
        ProcessorDescriptor.ParameterDescriptor mockParameterDescriptor1 = mock(ProcessorDescriptor.ParameterDescriptor.class);
        ...
        return parameterDescriptorList.toArray(new ProcessorDescriptor.ParameterDescriptor[parameterDescriptorList.size()]);
    }
