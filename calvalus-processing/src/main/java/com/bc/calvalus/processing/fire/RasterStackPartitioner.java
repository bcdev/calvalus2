 ...
 *
 * Adaption of L3Partitioner that allows for the generic RasterStackWritable.
 *
 * @author Marco Zuehlke
 * @author Norman Fomferra
 * @author Thomas Storm
 */
public class RasterStackPartitioner extends Partitioner<LongWritable, RasterStackWritable> implements Configurable {
    ...
    @Override
    public int getPartition(LongWritable binIndex, RasterStackWritable rasterStackWritable, int numPartitions) {
