...
public class ModisJDAggregator extends AbstractAggregator {
    ...
    public static class Descriptor implements AggregatorDescriptor {
        ...
        public static final String NAME = "MODIS-JD";
        ...
        public Aggregator createAggregator(VariableContext varCtx, AggregatorConfig aggregatorConfig) {
            ...
            return new ModisJDAggregator(NAME, new String[]{config.doyName, config.clName}, new String[]{"JD", "CL"}, getTargetVarNames(aggregatorConfig), new int[]{minDoy, maxDoy});
        }
