...
public class ModisFireGridDataSource extends AbstractFireGridDataSource {
    ...
    public ModisFireGridDataSource(String targetTile, Product[] sourceProducts, Product[] lcProducts) {
        this.tile = targetTile; // "773,470"
    ...
    public SourceData readPixels(int x, int y) throws IOException {
        ...
        int tileX = Integer.parseInt(tile.split(",")[0]);
        int tileY = Integer.parseInt(tile.split(",")[1]);
