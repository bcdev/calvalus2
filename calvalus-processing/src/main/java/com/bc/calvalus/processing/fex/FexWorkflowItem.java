...
/**
 * A workflow item creating a Hadoop job for n input products processed to n fez and features.
 */
public class FexWorkflowItem extends HadoopWorkflowItem {

    public FexWorkflowItem(HadoopProcessingService processingService, String username, String jobName, Configuration jobConfig) {
    ...
    protected String[][] getJobConfigDefaults() {
        return new String[][]{
                ...
                {"calvalus.fex.applicationName", NO_DEFAULT},
...
//                {JobConfigNames.CALVALUS_REGION_GEOMETRY, null},
    ...
    protected void configureJob(Job job) throws IOException {
        ...
        jobConfig.setIfUnset("calvalus.system.beam.reader.tileHeight", "200");
        jobConfig.setIfUnset("calvalus.system.beam.reader.tileWidth", "200");

        job.setInputFormatClass(PatternBasedInputFormat.class);

        job.setMapperClass(FexMapper.class);
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(Text.class);

        job.setNumReduceTasks(1);
        job.setReducerClass(FexReducer.class);
