...
public class CubeMapperTest extends TestCase {
    ...
    public class MapperProxy extends CubeMapper {
        ...
        public MapperProxy(Configuration conf) {
            this.conf = conf;
            conf.set("calvalus.l3.parameters", parameters.get("calvalus.l3.parameters"));
            conf.set("calvalus.output.dir", parameters.get("calvalus.output.dir"));
        }
        public class CubeMapperContext extends Context {
            ...
            public InputSplit getInputSplit() {
                return new ParameterizedSplit(
                        new Path(this.getClass().getClassLoader().getResource(parameters.get("inputPath")).getPath()),
                        965216L,
                        new String[] { "localhost" },
                        new String[] { "timeIndex", parameters.get("timeIndex"), "writeChunksOnly", parameters.get("writeChunksOnly") }
                );
            }
