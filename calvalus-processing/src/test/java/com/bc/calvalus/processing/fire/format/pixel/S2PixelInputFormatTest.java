...
public class S2PixelInputFormatTest {
    ...
    public void testGetInputPathPattern_1() throws Exception {
        String inputPathPattern = S2PixelInputFormat.getInputPathPattern("2015", "03", new S2Strategy().getArea("AREA_1"));
    ...
    public void testGetInputPathPattern_2() throws Exception {
        String inputPathPattern = S2PixelInputFormat.getInputPathPattern("2016", "12", new S2Strategy().getArea("AREA_15"));
