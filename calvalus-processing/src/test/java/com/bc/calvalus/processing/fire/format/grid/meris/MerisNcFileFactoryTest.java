...
public class MerisNcFileFactoryTest {
    ...
    public void acceptanceTestCreateNcFile() throws Exception {
        ...
        NetcdfFileWriter ncFile = new MerisNcFileFactory().createNcFile(".\\" + String.format("%s%s%s-ESACCI-L4_FIRE-BA-MERIS-f%s.nc", "2008", "06", true ? "07" : "22", "04.1"), "v4.1", timeCoverageStart, timeCoverageEnd, 15, 18);
        ncFile.close();
    }
