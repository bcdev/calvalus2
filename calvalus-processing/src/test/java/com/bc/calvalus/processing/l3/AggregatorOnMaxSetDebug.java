 ...
 */
public final class AggregatorOnMaxSetDebug extends AbstractAggregator {

    private final int onMaxIndex;
    private final int[] setIndexes;
    private final int numSetFeatures;

    public AggregatorOnMaxSetDebug(VariableContext varCtx, String onMaxVarName, String targetName, String... setVarNames) {
    ...
    public void aggregateSpatial(BinContext ctx, Observation observationVector, WritableVector spatialVector) {
        ...
        SystemUtils.LOG.info("aggregateSpatial " + ctx.getIndex() + " onmaxvar contribution=" + value);
    ...
    public void completeSpatial(BinContext ctx, int numObs, WritableVector numSpatialObs) {
        SystemUtils.LOG.info("completeSpatial " + ctx.getIndex() + " numObs=" + numObs);
    }
    ...
    public void aggregateTemporal(BinContext ctx, Vector spatialVector, int numSpatialObs,
        ...
        SystemUtils.LOG.info("aggregateTemporal " + ctx.getIndex() + " onmaxvar contribution=" + value);
    ...
    public void computeOutput(Vector temporalVector, WritableVector outputVector) {
        for (int i = 0; i < numSetFeatures + 2; i++) {
            ...
            SystemUtils.LOG.info("computeOutput " + "?" + " value[" + i + "]=" + value);
    ...
    public String toString() {
        return "AggregatorOnMaxSetDebug{" +
    ...
    public static class Descriptor implements AggregatorDescriptor {
        ...
        public static final String NAME = "ON_MAX_SET_DEBUG";
        ...
        public Aggregator createAggregator(VariableContext varCtx, AggregatorConfig aggregatorConfig) {
            ...
            return new AggregatorOnMaxSetDebug(varCtx, config.onMaxVarName, targetName, config.setVarNames);
        }
