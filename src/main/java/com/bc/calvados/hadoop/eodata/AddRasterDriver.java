...
import com.bc.calvados.hadoop.io.RasterInputFormat;
import com.bc.calvados.hadoop.io.RasterOutputFormat;
...
// bin/hadoop jar hadoop-tests-1.0.jar com.bc.calvados.hadoop.eodata.AddRasterDriver input output

//
public class AddRasterDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(getConf(), "NormansHodoopTest");
        ...
        job.setMapperClass(AddRasterMapper.class);
        job.setReducerClass(AddRasterReducer.class);
    ...
    public static void main(String[] args) throws Exception {
        System.exit(ToolRunner.run(new AddRasterDriver(), args));
    }
}
