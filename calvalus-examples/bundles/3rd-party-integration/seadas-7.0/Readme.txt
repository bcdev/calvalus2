...
java -jar ~/Projects/BC/Calvados/calvalus/calvalus-production/target/calvalus-production-2.0-tool.jar --uninstall seadas-7.0
java -jar ~/Projects/BC/Calvados/calvalus/calvalus-production/target/calvalus-production-2.0-tool.jar -deploy bundle-descriptor.xml l2gen-p* seadas-7.0.tgz seadas-7.0
