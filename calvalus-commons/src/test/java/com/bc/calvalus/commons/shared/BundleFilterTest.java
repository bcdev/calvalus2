...
public class BundleFilterTest {
    ...
    public void testToString() throws Exception {
        ...
        assertEquals("exceptionmapper=ALL_USER,USER;bundle=testname,9.9;processor=proc,1.7-SNAPSHOT;user=Marco", filter.toString());
    ...
    public void testToStringNotAllValuesSet() throws Exception {
        ...
        assertEquals("exceptionmapper=USER;processor=c2r,1.0", filter.toString());
    }

    @Test
    public void testFromString() throws Exception {
        final BundleFilter filter = BundleFilter.fromString("exceptionmapper=SYSTEM,USER;bundle=coastcolour,1.6;processor=idepix,1.8-cc;user=Hugo");
