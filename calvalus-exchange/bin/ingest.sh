...
then
    ...
    echo "usage  : $0 <source-dir> [productType] [reprocessing]"
    echo "example: $0 /hd3"
    echo "creates e.g. hdfs://cvmaster00:9000/calvalus/eodata/MER_RR__1P/r03/2010/11/17"
    echo "example: $0 /hd3 MER_FR__1P cc"
    echo "creates e.g. hdfs://cvmaster00:9000/calvalus/eodata/MER_FR__1P/cc/2010/11/17"
